...
const Navbar = () => {
    ...
    // create one variable, correspond to menu-icon
  ...
  return ( 
    ...
    <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
        ...
        <div className='flex items-center gap-6'>
            ...
            <img onClick={()=>setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer' alt="" />  {/*sm:hidden*/}
        </div>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                ...
                <NavLink onClick={()=>setVisible(false)} className='py-2 pl-6 border hover:bg-black hover:text-white' to='/collection'>COLLECTION</NavLink>
